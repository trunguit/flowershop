...
Route::group(['prefix' =>  $prefix], function () use ($controllerName) {
    ...
    Route::group(['prefix' =>  $prefix], function () use ($controllerName) {
        ...
        Route::get('form/{id?}',                    [ 'as' => $controllerName . '/form',        'uses' => $controller . 'form'])->where('id', '[0-9]+');
        Route::post('save',                         [ 'as' => $controllerName . '/save',        'uses' => $controller . 'save']);
        Route::get('pdf/{id}',                         [ 'as' => $controllerName . '/pdf',        'uses' => $controller . 'pdf']);
        Route::get('delete/{id}',                   [ 'as' => $controllerName . '/delete',      'uses' => $controller . 'delete'])->where('id', '[0-9]+');
        Route::get('change-status-{status}/{id}',   [ 'as' => $controllerName . '/status',      'uses' => $controller . 'status'])->where('id', '[0-9]+');
    });
   //============================== VIDEO ==================================
    ...
    Route::group(['prefix' =>  $prefix], function () use ($controllerName) {
     ...
     // ============================== Article Comment ==============================
     $prefix         = 'article-comment';
     $controllerName = 'articleComment';
     Route::group(['prefix' =>  $prefix], function () use ($controllerName) {
         $controller = ucfirst($controllerName)  . 'Controller@';
         Route::get('/',                             [ 'as' => $controllerName,                  'uses' => $controller . 'index' ]);
         Route::get('form/{id?}',                    [ 'as' => $controllerName . '/form',        'uses' => $controller . 'form'])->where('id', '[0-9]+');
...
Route::group(['prefix' =>  $prefix], function () use ($controllerName) {
    ...
    Route::group(['prefix' => $prefix], function () use ($controllerName) {
        ...
        Route::get('change-config-{type_menu}/{id}', ['as' => $controllerName . '/type_menu',    'uses' => $controller . 'typeMenu'])->where('id', '[0-9]+');
    ...
    Route::group(['prefix' => $prefix], function () use ($controllerName){
        ...
        Route::post('/page-setting',         [ 'as' => $controllerName . '/page_setting',         'uses' => $controller . 'page' ]);
    ...
    Route::group(['prefix' => $prefix], function () use ($controllerName) {
     ...
     Route::group(['prefix' =>  $prefix], function () use ($controllerName) {
         ...
         Route::get('config-{config}/{value}/{id}',      [ 'as' => $controllerName . '/config',      'uses' => $controller . 'config'])->where('id', '[0-9]+');
         Route::get('attribute/{id}',                    [ 'as' => $controllerName . '/attribute',   'uses' => $controller . 'attribute']);
         Route::get('change-config-{config}/{id}', ['as' => $controllerName . '/config',    'uses' => $controller . 'config'])->where('id', '[0-9]+');
         Route::get('change-category-{category_id}/{id}', [ 'as' => $controllerName . '/change-category', 'uses' => $controller . 'changeCategory']);
     });
