...
@section('content')
    <div class="section-category">
        @include('news.block.breadcrumb1', ['item' => ['name' => 'Thư viện Video']])
        <?php
...
?>
    <ul>
        @foreach($playlist->items as $item)
                <iframe width="33%" height="250px" src="https://www.youtube.com/embed/<?php echo $item->snippet->resourceId->videoId ;?>" frameborder="0" allowfullscreen=""></iframe>
        @endforeach   
    </ul>
        </div>
@endsection