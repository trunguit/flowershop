...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            ...
            <li>
                <a><i class="fa fa-cog"></i>Quản lý sản phẩm <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="{{ route('cateProduct') }}"></i>Danh mục</a></li>
                    <li><a href="{{ route('product') }}"></i>Sản phẩm</a></li>
                    <li><a href="{{ route('productAttribute') }}"></i>Thuộc tính</a></li>
                </ul>
            </li>
            <li>
                <a><i class="fa fa-cog"></i>Article <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="{{ route('articleComment') }}"></i >Bình luận bài viết</a></li>
                    <li><a href="{{ route('article') }}"></i> Article</a></li>
                </ul>
            </li>
            <li><a href="{{ route('slider') }}"><i class="fa fa-sliders"></i> Silders</a></li>
            <li><a href="{{ route('rss') }}"><i class="fa fa-rss"></i> RSS</a></li>
            
            <li><a href="{{ route('qa') }}"><i class="fa fa-question-circle"></i> Q&A</a></li>
