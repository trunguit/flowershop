...
class ArticleModel extends AdminModel
{
    ...
    public function listItems($params = null, $options = null) {
        ...
        if($options['task'] == 'news-list-comment') {
            // $this->table               = 'article_comment as c';
            $article_id = $params['article_id'];
            $query = $this->select('id','name','content','time')
        ...
        if($options['task'] == 'news-list-items-new') {
            ...
            $query = $this->select('a.id', 'a.name', 'a.created','a.created_by', 'a.category_id','a.content', 'c.name as category_name', 'a.thumb')
                ->leftJoin('category as c', 'a.category_id', '=', 'c.id')
                ->where('a.status', '=', 'active')
                ->orderBy('id', 'desc') 
                ->take(3);
    ...
    public function saveItem($params = null, $options = null) { 
        ...
        if ($options['task'] == 'news-add-comment') {
